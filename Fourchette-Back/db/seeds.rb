...
nbcheesecake = Recipe.find_or_create_by(name: "No-Bake Three-Cheese Cheesecake", image: "http://images.ctfassets.net/3gxybr5ur7hf/QFlJsmrN60g8O00uqu8Eq/a5f625a4ddee35ed4b7a6fb161f82e64/image_4155.jpeg", user_id: mae.id, copy: false, intro: "This recipe is here by way of happy accident. I didn't have enough of this or that for the recipe I'd originally set out to make. But I had ideas on how to get around it. And here we are. This is my new favorite and I've made it with lots of toppings: strawberries, mixed berries, and a combination of plums, white peaches, and loganberries.
...
medmeatballs = Recipe.find_or_create_by(name: "Mediterranean-ish Lamb Meatballs", image: "https://cook.fnr.sndimage.com/content/dam/images/cook/fullset/2017/2/6/0/CCTIA0306H_Lamb-Balls_s4x3.jpg.rend.hgtvcom.826.620.suffix/1486402571442.jpeg", user_id: camille.id, copy: true, prev_recipe_id: lambmeatballs.id, intro: "I tweaked the flavors / seasoning from the original to be a bit more Mediterranean / kofta-inspired. I didn't have currants, so I used golden raisins which added lovely sweetness! These take so well to edits -- you could add za'atar or cumin, you could replace the currants with some finely chopped nuts, you could certainly try other types of meat besides lamb... YUM", steps: "Step 1
